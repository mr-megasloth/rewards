...
<?php 
                ...
                while($row = mysqli_fetch_assoc($select_all_challenges_query)) {
                    ...
                    while($company_row = mysqli_fetch_assoc($select_partner_query)){
                        $challenge_partner_name = $company_row['name'];
                    }  
...
<?php 
    ...
    if(isset($_GET['delete'])){
        ...
        echo "<script> location.replace('personal-challenges.php?deleted=true'); </script>";         
    }    
?>
...
<?php 
    ...
    if(isset($_GET['clone'])){
        ...
        echo "<script> location.replace('personal-challenges.php?cloned=true'); </script>";         
    }    
?>
